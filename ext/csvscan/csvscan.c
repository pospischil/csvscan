...
static const unsigned char _csv_scan_trans_keys[] = {
	10u, 34u, 9u, 10u, 13u, 32u, 34u, 44u, 
	11u, 12u, 10u, 13u, 34u, 44u, 10u, 34u, 
	0
};
...
static const char _csv_scan_trans_targs[] = {
	1, 5, 1, 2, 2, 4, 2, 1, 
	2, 3, 3, 2, 2, 2, 2, 3, 
	2, 2, 1, 2, 2, 2, 2, 2, 
	0
...
static const char _csv_scan_trans_actions[] = {
	1, 24, 0, 5, 31, 0, 5, 0, 
...
static const char _csv_scan_eof_trans[] = {
	0, 22, 0, 22, 23, 24
};
...
_match:
_eof_trans:
	cs = _csv_scan_trans_targs[_trans];

	if ( _csv_scan_trans_actions[_trans] == 0 )
		goto _again;

	_acts = _csv_scan_actions + _csv_scan_trans_actions[_trans];
	_nacts = (unsigned int) *_acts++;
	while ( _nacts-- > 0 )
	{
		switch ( *_acts++ )
...
#line 377 "csvscan.c"
	...
	if ( p == eof )
	{
	if ( _csv_scan_eof_trans[cs] > 0 ) {
		_trans = _csv_scan_eof_trans[cs] - 1;
		goto _eof_trans;
	}
	}
